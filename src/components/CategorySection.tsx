...
const CategorySection = ({ onSelectCategory, onGoBack }: CategorySectionProps) => {
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-8 animate-fade-in">
      {/* Back Button */}
      <button
        onClick={onGoBack}
        className="absolute top-8 left-8 bg-pink-600 hover:bg-pink-700 text-white px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105"
      >
        ← Zurück
      </button>
      ...
      <p className="text-xl text-pink-200 mb-16 text-center max-w-2xl">
        Entdecke unsere exklusiven Video- und Foto-Kollektionen
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl w-full">
        ...
        <div
          ...
          className="group relative bg-gradient-to-br from-pink-900/30 to-purple-900/30 backdrop-blur-md rounded-2xl p-12 border border-pink-500/30 cursor-pointer transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-pink-500/20 hover:border-pink-400/50 animate-slide-in-right"
        >
          {/* Background Pattern */}
        ...
        <div
          ...
          className="group relative bg-gradient-to-br from-purple-900/30 to-pink-900/30 backdrop-blur-md rounded-2xl p-12 border border-purple-500/30 cursor-pointer transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/20 hover:border-purple-400/50 animate-slide-in-right"
      ...
      {/* Decorative Elements */}
      <div className="absolute top-20 right-20 animate-spin" style={{ animationDuration: '20s' }}>
        <div className="w-8 h-8 border-2 border-pink-400 rounded-full opacity-30" />
      </div>
      <div className="absolute bottom-20 left-20 animate-spin" style={{ animationDuration: '15s' }}>
